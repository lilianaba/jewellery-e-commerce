...
db.once("open", async () => {
  ...
  const products = await Product.insertMany([
    ...
    {
      name: "Bead Chain",
      description: "45cm Multi-Layer Bead Chain in Sterling Silver",
      image: "2.jpg",
      category: categories[0]._id,
      price: 150,
      quantity: 10,
    },
    {
      ...
      description: "Stud Earrings with Morganite in 10kt Rose Gold",
      image: "4.jpg",
      price: 500,
      quantity: 8,
    },
    ...
    },
    {
      ...
      description: "9ct Yellow Gold Natural Sapphire + Zirconia Ring",
      image: "7.jpg",
      price: 722,
      quantity: 4,
    },
    ...
    },
    {
      ...
      category: categories[5]._id,
      description: `A modern slimline watch that features an all-over yellow gold-plated stainless-steel construction, the Jag J2523A Alice Gold Tone Women's Watch boasts simplicity in an elegant style. Featuring a 32mm dial with button time markers and a white backdrop, this timepiece will radiate from the wrist to proclaim its beauty. It is JAG in all its glory, with the clever addition of a minimalist mesh band that helps to accentuate the clarity of the watch face. A true classic that will certainly add sophistication and a tasteful appeal to your look.`,
      image: "16.jpeg",
      price: 111.75,
      quantity: 32,
    },
    ...
    },
    {
      ...
      category: categories[5]._id,
      description: `Add a touch of playfulness to your look with this Olivia Burton watch adorned with a 3D daisy chain motif and a chalk blue leather strap.`,
      image: "18.jpeg",
      price: 459,
      quantity: 5,
    },
    ...
    },
    {
      ...
      category: categories[1]._id,
      description: `Black sapphire is said to deflect stress and negativity, making it perfect for use in jewellery. These 9ct Yellow Gold 6x4mm Natural Sapphire and Diamond Pear Halo Studs are entrancing, calming, and full of deep colour to adore. Cut into a beautiful pear shape and coated with diamonds, these elegant gemstones add sophistication and depth to any look. Yellow gold offers a luxury backdrop that completes this incredible pair.`,
      image: "24.webp",
      price: 999,
      quantity: 13,
    },
    ...
    },
    {
      ...
      category: categories[4]._id,
      description: `This solid 9ct yellow gold chain is sure to please. The bevelled curb chain is 45cm in length.`,
      image: "26.webp",
      price: 599.5,
      quantity: 98,
    },
    {
      ...
      category: categories[4]._id,
      description: `Sterling Silver Rhodium Plated Fancy 43cm Cleopatra Chain`,
      image: "27.jpeg",
      price: 459,
      quantity: 3,
    },
